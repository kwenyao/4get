...
namespace Message{
	...
	const string MESSAGE_ERROR_NO_DESCRIPTION    = "Error: Please enter a description.";
	...
	const string MESSAGE_ERROR_DATE_PASSED                   = "Error: The date you have entered has already passed.";
	const string MESSAGE_ERROR_START_AFTER_END               = "Error: Start time should not be before end time.";
